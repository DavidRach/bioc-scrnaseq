...
This approach is implemented below using the `scDblFinder` library. We then visualize the scores in a t-SNE plot. (Here we use a custom processing function to use `scrapper` to do the normalization, though if this isn't specified scDblFinder will do the same thing with `scater`)
